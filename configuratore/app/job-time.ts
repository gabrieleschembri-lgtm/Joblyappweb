export const getJobStartDate = (job: Record<string, any>): Date | null => {
...
export const isJobPast = (job: Record<string, any>, now: Date = new Date()): boolean => {
